...
from old.controller.AD2CaptDeviceController import AD2CaptDeviceController
from old.model.AD2CaptDeviceModel import AD2CaptDeviceModel
from old.model.AD2Constants import AD2Constants
from old.view.Ui_AD2ControlWindow import Ui_AD2ControlWindow
from old.view.widget.WidgetCapturingInformation import WidgetCapturingInformation, WidgetDeviceInformation
...
class ControlWindow(QMainWindow):
    ...
    def _connect_controls(self):
       ...
       # self.model.ad2captdev_config.connect_sample_rate_changed(self._ui.sb_acquisition_rate)
    ...
    def on_btn_start_capture_clicked(self):
        print(self.model.device_capturing_state)

...
from old.controller.mp_AD2Capture.AD2StateMPSetter import AD2StateMPSetter
...
def mp_capture(data_queue, capture_data_queue, state_queue,
    ...
    :param dwf: FDwf object.
    :param hdwf: Device handle.
    ...
    while end_process.value == False:
        ...
        dwf.FDwfAnalogInStatus(hdwf, c_int(1), byref(ad2_state.ain_device_state))  # Variable to receive the acquisition state
...
def _mp_discover_connected_devices(dwf):
    ...
    filter, type = (c_int32(enumfilterType.value | enumfilterUSB.value | enumfilterDemo.value), 'Simulator')

...
from old.controller.BaseAD2CaptDevice import BaseAD2CaptDevice
...
#    AnalogOutNodeCarrier, enumfilterUSB, enumfilterType, funcTrapezium, enumfilterDemo, enumfilterAll

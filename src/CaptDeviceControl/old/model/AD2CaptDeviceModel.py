...
class AD2CaptDeviceSignals(QObject):
    ...
    ad2captdev_config_changed = Signal(CaptDeviceConfig)
...
class AD2CaptDeviceModel:
    ...
    def __init__(self, ad2captdev_config: CaptDeviceConfig):
    ...
    @property
    def ad2captdev_config(self) -> CaptDeviceConfig:
        return self._ad2captdev_config

    @ad2captdev_config.setter
    def ad2captdev_config(self, value: CaptDeviceConfig):

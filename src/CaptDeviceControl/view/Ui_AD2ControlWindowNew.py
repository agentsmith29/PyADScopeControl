...
"")
        ...
        self.vl_header.setFocusPolicy(Qt.NoFocus)
        self.vl_header.setFrameShape(QFrame.NoFrame)
        self.vl_header.setFrameShadow(QFrame.Raised)
...
"")
        icon = QIcon()
        icon.addFile(u":/icons-svg/icons-svg/cil-media-play.svg", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon1 = QIcon()
        icon1.addFile(u":/icons-svg/icons-svg/cil-media-stop.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        icon2 = QIcon()
        icon2.addFile(u":/icons-svg/icons-svg/cil-media-pause.svg", QSize(), QIcon.Normal, QIcon.Off)
